...
@click.option('--year', default=2021, type=int, show_default=True, help='Taxi data year')
@click.option('--month', default=1, type=int, show_default=True, help='Taxi data month')
@click.option('--chunksize', default=100000, type=int, show_default=True, help='CSV chunk size')
